...
export default class extends React.PureComponent {
  ...
  translate = (t) => translate(t, 'admin', this.props.query.locale, {
    // "countries": true,
    "sectors": true,
  ...
  redirectToVerification = (email, verificationCode) => {
    ...
    Router.replaceRoute('adminVerification', {
  ...
  onRequestAdminAccessToken = (mutate) => {
  ...
  onMutationCompleted = ({requestAdminAccessToken: email}) => {
    console.log('requestAdminAccessToken', email);
          ...
          <section className="s-section target-section first last">
            ...
            <div className="row section-header">
              <div className="col-full">
                ...
                <Mutation
                  mutation={REQUEST_ADMIN_ACCESS_TOKEN}
                ...
                >
                  {(mutate, { loading, error, called, data }) => {
                    ...
                    return <LoginForm onSubmit={(e) => { e.preventDefault(); }}>
                      ...
                      <FormSection className="FormSection">
                        <h3 className="subhead">{this.translate('adminLogin')}</h3>
                        ...
                        <FormTools>
                          <div className="full-width">
                            <button className={classNames({
                              ...
                              this.onRequestAdminAccessToken(mutate)
                            }}>
                              {
